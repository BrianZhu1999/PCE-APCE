...
def main() -> None:
    ...
    upper_background.set_facecolor("#F8FBFD")
    lower_background.set_facecolor("#FEFAF8")

    # Observation-conditioned:
    # nearly white below -> restrained pale blue above.
    upper_gradient_ax = _add_background_gradient(
        fig,
        upper_bg_y0,
        upper_bg_y1,
        color_bottom="#FAFCFD",
    ...
    # Observation-free propagation:
    # restrained pale rose below -> nearly white above.
    lower_gradient_ax = _add_background_gradient(
        fig,
        lower_bg_y0,
        lower_bg_y1,
        color_bottom="#F8EAE5",
    ...
    # END GRADIENT BACKGROUND OVERLAY

    # BEGIN SOFT VIGNETTE OVERLAY
    # Very subtle edge darkening for added depth.
    # Geometry is inherited from the final background regions above.
    upper_vignette_ax = _add_soft_vignette(
        fig,
        upper_bg_y0,
        upper_bg_y1,
        color="#9FB5C5",
    ...
    lower_vignette_ax = _add_soft_vignette(
        fig,
        lower_bg_y0,
        lower_bg_y1,
        color="#C7AEA6",
    ...
    base = args.output / "figure5_panels_bcde_x40y20_0803_best_mse_gradient"
    ...
    (args.output / "figure5_panels_bcde_x40y20_0803_best_mse_gradient_metadata.json").write_text(json.dumps(metadata, ensure_ascii=False, indent=2), encoding="utf-8")
