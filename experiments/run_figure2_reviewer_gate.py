...
NEW_METHODS = ("aug_enkf", "bma_static", "pce_refined", "apce_refined", "pce_refined_v2", "apce_refined_v2")
LABELS = {
    "aug_enkf": "Aug-state EnKF",
    "bma_static": "Bayesian model averaging",
    "pce_refined": "PCE-refined",
    "apce_refined": "APCE-refined",
    "pce_refined_v2": "PCE-refined-v2",
    "apce_refined_v2": "APCE-refined-v2",
}
...
def run_spring_heat_refined_v2(
    ...
    source_method = "pce" if method == "pce_refined_v2" else "apce"
...
def run_case_method_seed(
    ...
    *,
    ...
    if case == "wave":
        ...
        elif method in {"pce_refined", "apce_refined"}:
            result = run_wave_refined(assets, method, device)
        elif method in {"pce_refined_v2", "apce_refined_v2"}:
        ...
        if method == "aug_enkf":
            ...
            result = run_spring_heat_refined(scenario, method, device)
        elif method in {"pce_refined_v2", "apce_refined_v2"}:
    ...
    result.update(
        ...
        protocol=(
            ...
            if protocol is not None
                ...
                "figure2-reviewer-gate-5paired-seeds-20260810-v2-local-mixture"
                if method.endswith("_v2")
                else "figure2-reviewer-gate-5paired-seeds-20260810-v1"
            )
        ),
