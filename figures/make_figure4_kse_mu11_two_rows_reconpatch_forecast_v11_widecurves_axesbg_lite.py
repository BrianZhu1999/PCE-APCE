...
OUTPUT_BASE = HERE / "figure4_kse_mu11_two_rows_reconpatch_forecast_v11_widecurves_axesbg_lite"


def save_all_v61(fig, output_base: Path) -> None:
    apply_v59_axes_style(fig, background=KSE_BACKGROUND_LITE)
    save_axes_background_with_transparent_figure(
        fig,
        output_base,
        dpi=650,
