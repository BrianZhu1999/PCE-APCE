...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v34_panel_i_left"
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 34: starts from v33; keeps the panel-i label and title aligned with panel g while shifting the panel-i legend and radar axes slightly left; all data and panels a-h are unchanged",
