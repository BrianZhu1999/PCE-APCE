...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v31_from_v27_no_key_outer_band"
...
def panel_radar_summary(
    ...
    panel_grid = GridSpecFromSubplotSpec(2, 1, subplot_spec=subplot_spec, height_ratios=[0.105, 1.00], hspace=0.000)
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 31: starts from v27 as the visual master; removes the abbreviation key; expands panel-i radar outer bands outward by keeping the inner edge outside the unit circle and increasing the radial thickness",
