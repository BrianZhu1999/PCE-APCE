...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v13_weight_heatmap"
...
def panel_weight_heatmap(
    ...
    cmap = mcolors.LinearSegmentedColormap.from_list(
        "apce_weight_map",
        ["#FBFAF7", "#F5DFC5", "#F0A35E", "#B95025", "#5D1F12"],
    )
    cmap.set_bad("#F2F2F2")
...
Figure archetype:
Strict three-row mixed-modality evidence wall. Version 13 replaces the former cognitive-weight line plot with a discrete cognitive-weight heatmap to match the candidate-alpha evidence structure.

Panel map:
a-c: representative dynamics.
e: final cognitive-weight map over candidate alpha values for PCE and APCE across Wave, Spring and Heat.
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 13: first row a-c plus e equal-width panels; e is a cognitive-weight heatmap over candidate alpha values; second row f/g; third row h/i",
        "backend": "python/matplotlib",
        "font": "Arial with sans-serif fallback",
        "font_weight": "regular except panel letters",
        "formats": ["svg", "pdf", "png", "tiff"],
        "changed_from_v12": "only panel e changed from line plot to cognitive-weight heatmap; v12 outputs are not overwritten",
    }
