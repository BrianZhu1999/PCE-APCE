...
OUTPUT_BASE = HERE / "figure4_kol_vorticity_reconstruction_1x4_v20_bottomcbar_midgap07_cbarh15_labelbottom"
...
def main() -> None:
    ...
    fig.text(
        (x_positions[0] + (x_positions[-1] + image_w - x_positions[0]) / 2.0) / FIG_W,
        0.945,
    ...
    cbar_x = x_positions[0]
    cbar_w = x_positions[-1] + image_w - x_positions[0]
    cbar_y = 0.43
    cbar_h = 0.15
