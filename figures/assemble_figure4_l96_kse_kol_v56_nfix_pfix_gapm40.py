...
L96_PATH = HERE / "figure4_l96_row_v7_palette_attachment1.png"
KSE_PATH = HERE / "figure4_kse_mu11_two_rows_reconpatch_forecast_v7_i_palette_attachment2.png"
KOL_PANEL = HERE / "figure4_kol_vorticity_reconstruction_1x4_v16_ref_label.png"
KOL_PANEL_N = HERE / "figure4_kol_quant_panel_n_v9_ymins_reflegend.png"
KOL_FORECAST_ROW = HERE / "figure4_kol_forecast_panels_op_v2_metric_palette_insets.png"

OUTPUT_BASE = HERE / "figure4_reordered_l96_kse_kol_v56_nfix_pfix_gapm40"
...
def main() -> None:
    ...
    kol_forecast = Image.open(KOL_FORECAST_ROW).convert("RGBA")
    if kol_forecast.width != CANVAS_W:
        raise ValueError(f"KOL forecast row width {kol_forecast.width} differs from canvas width {CANVAS_W}")

    kol_row_h = max(kol.height, kol_n.height)
    total_h = (
        TOP_MARGIN
        + L96_TITLE_BAND
        + l96.height
    ...
    y += kol_row_h + KOL_FORECAST_GAP
    canvas.alpha_composite(kol_forecast, (0, y))
    ...
    qa = {
        ...
        "input_kol_forecast": str(KOL_FORECAST_ROW),
        "input_kol_forecast_sha256": sha256(KOL_FORECAST_ROW),
        ...
        "kol_mn_to_op_gap_px": KOL_FORECAST_GAP,
