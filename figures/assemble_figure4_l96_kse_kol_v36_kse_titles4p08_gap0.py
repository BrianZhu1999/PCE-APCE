...
if __name__ == "__main__":
    ...
    try:
        ...
        base.KSE_INNER_GAP = 0
        base.OUT_PNG = HERE / "figure4_reordered_l96_kse_v20_title20_kse_titles4p08_gap0.png"
        base.OUT_PDF = HERE / "figure4_reordered_l96_kse_v20_title20_kse_titles4p08_gap0.pdf"
        base.OUT_TIFF = HERE / "figure4_reordered_l96_kse_v20_title20_kse_titles4p08_gap0.tiff"
        base.main()
    finally:
    ...
    try:
        kol_assembly.INPUT_PNG = HERE / "figure4_reordered_l96_kse_v20_title20_kse_titles4p08_gap0.png"
        kol_assembly.KOL_PANEL = HERE / "figure4_kol_vorticity_reconstruction_1x4_v12_titlegap_up_tlabels.png"
        kol_assembly.OUTPUT_BASE = HERE / "figure4_reordered_l96_kse_kol_v36_kse_titles4p08_gap0"
