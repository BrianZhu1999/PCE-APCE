...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v27_radar_key_cleanup"
...
def panel_radar_summary(
    ...
    panel_grid = GridSpecFromSubplotSpec(3, 1, subplot_spec=subplot_spec, height_ratios=[0.105, 1.00, 0.125], hspace=0.000)
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 27: preserves accepted panels a-h; keeps the reduced gap above panel i and widened radar bands; moves radar case labels upward and lowers the compact abbreviation key to remove overlap",
