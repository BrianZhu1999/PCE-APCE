...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v23_normalized_radar_profiles"
...
Figure archetype:
Four-row mixed-modality evidence wall. Version 23 keeps the accepted Version 18 panels a-h and replaces the radar summary with an all-method normalized-score panel: one unified method legend, three enlarged radar charts, coloured outer group bands and custom polygon grids.
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 23: preserves accepted v18 panels a-h; replaces the v22 radar with an all-method normalized-score panel i using one unified method legend, three enlarged equal-size radar charts, coloured outer group bands, grey polygon background and custom rings/spokes; polygons are filled from larger to smaller areas following the reference style",
        "backend": "python/matplotlib",
        "font": "Arial with sans-serif fallback",
        "font_weight": "regular except panel letters",
        "formats": ["svg", "pdf", "png", "tiff"],
        "changed_from_v22": "removes artificial baseline/cognitive radial banding, redesigns panel i only, keeps no true-alpha marker, no Oracle, continuous panel labels a-i, and the d-panel right-side vertical colorbar with ticks 0 and 1 only",
