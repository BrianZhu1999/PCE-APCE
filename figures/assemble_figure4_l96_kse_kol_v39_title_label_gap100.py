...
KOL_PANEL = HERE / "figure4_kol_vorticity_reconstruction_1x4_v12_titlegap_up_tlabels.png"

OUTPUT_BASE = HERE / "figure4_reordered_l96_kse_kol_v39_title_label_gap100"

CANVAS_W = base.CANVAS_W
TOP_MARGIN = base.TOP_MARGIN
ROW_GAP = base.ROW_GAP
KSE_INNER_GAP = -40
...
def main() -> None:
    ...
    if kol.width > CANVAS_W // 2:
        raise ValueError(f"KOL panel width {kol.width} exceeds half-width {CANVAS_W // 2}")
