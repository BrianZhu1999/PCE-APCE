...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v25_radar_label_legend_linefix"
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 25: preserves accepted panels a-h; moves the panel-i legend and case labels upward; spreads the left and right radar charts outward; flips the Reliability tests band label; improves LETKF visibility without changing data",
