...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v35_panel_i_legend_realigned"
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 35: starts from v34; keeps the panel-i label and title aligned with panel g, keeps the radar axes slightly left, and restores the panel-i legend to the same horizontal centre as the e-h legend; all data and panels a-h are unchanged",
