...
OUTPUT_BASE = HERE / "figure4_kol_vorticity_reconstruction_1x4_v14_midgap05_cbar60"
...
def main() -> None:
    ...
    colorbar = fig.colorbar(image, cax=cax, orientation="vertical", extend="both", extendfrac=0.074)
    ...
    qa = {
        ...
        "colorbar_extendfrac": 0.074,
        "colorbar_tip_target_apex_angle_degrees": 60,
