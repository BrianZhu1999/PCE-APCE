...
if __name__ == "__main__":
    ...
    try:
        ...
        base.KSE_INNER_GAP = -20
        base.OUT_PNG = HERE / "figure4_reordered_l96_kse_v21_title20_kse_titles4p08_gapm20.png"
        base.OUT_PDF = HERE / "figure4_reordered_l96_kse_v21_title20_kse_titles4p08_gapm20.pdf"
        base.OUT_TIFF = HERE / "figure4_reordered_l96_kse_v21_title20_kse_titles4p08_gapm20.tiff"
        base.main()
    finally:
    ...
    try:
        kol_assembly.INPUT_PNG = HERE / "figure4_reordered_l96_kse_v21_title20_kse_titles4p08_gapm20.png"
        kol_assembly.KOL_PANEL = HERE / "figure4_kol_vorticity_reconstruction_1x4_v12_titlegap_up_tlabels.png"
        kol_assembly.OUTPUT_BASE = HERE / "figure4_reordered_l96_kse_kol_v37_kse_titles4p08_gapm20"
