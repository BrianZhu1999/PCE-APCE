...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v32_font_plus_radar_ticks"
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 32: starts from v31; increases all base figure fonts by one point; moves panel-i radar spoke labels outward; changes radar radial labels and grid rings to 0, 0.2, 0.4, 0.6, 0.8 and 1",
