...
OUTPUT_BASE = HERE / "figure4_l96_row_v7_palette_attachment1"

ATTACHMENT1_METHOD_COLORS = {
    "Aug-EnKF": "#a0a0a4",
    "BMA": "#feb933",
    "PCE": "#838300",
    "APCE": "#00b6a5",
}
base.METHOD_COLORS.update(ATTACHMENT1_METHOD_COLORS)
base.METHOD_COLORS["Truth"] = "#111111"
...
def main() -> None:
    ...
    base.draw_lead_metric(ax_nrmse, lead_rows, "lead_nrmse", "Fore. nRMSE", "nRMSE", threshold=0.20)
    ax_nrmse.set_title("")
