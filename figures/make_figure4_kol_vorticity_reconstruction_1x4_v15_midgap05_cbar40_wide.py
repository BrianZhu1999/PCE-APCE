...
OUTPUT_BASE = HERE / "figure4_kol_vorticity_reconstruction_1x4_v15_midgap05_cbar40_wide"
...
def main() -> None:
    ...
    colorbar = fig.colorbar(image, cax=cax, orientation="vertical", extend="both", extendfrac=0.118)
