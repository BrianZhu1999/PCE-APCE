...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v38_forest_single_row_clean"
...
def panel_forest_single_row(fig: plt.Figure, subplot_spec, run_rows: list[dict[str, str]]) -> None:
    panel_grid = GridSpecFromSubplotSpec(2, 1, subplot_spec=subplot_spec, height_ratios=[0.14, 1.0], hspace=0.10)
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 38: starts from v37; keeps panels a-h unchanged and keeps panel i as a single-row six-panel forest summary with a cleaner header",
