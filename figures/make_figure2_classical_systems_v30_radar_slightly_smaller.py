...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v30_radar_slightly_smaller"
...
def panel_radar_summary(
    ...
    for index, case in enumerate(base.CASES):
        ...
        y0 = bbox.y0 + 0.5 * (bbox.height - height) - 0.008
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 30: preserves accepted panels a-h; removes the abbreviation key; keeps the outward-expanded panel-i outer radar bands; slightly reduces radar chart scale relative to v29",
