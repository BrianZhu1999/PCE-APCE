...
OUTPUT_STEM = "figure2_classical_uncertain_systems_v28_radar_outer_band_bigger"
...
def panel_radar_summary(
    ...
    panel_grid = GridSpecFromSubplotSpec(2, 1, subplot_spec=subplot_spec, height_ratios=[0.095, 1.00], hspace=-0.055)
...
def main() -> None:
    ...
    qa = {
        "figure": OUTPUT_STEM,
        "layout": "version 28: preserves accepted panels a-h; removes the abbreviation key; expands panel-i outer radar bands outward while keeping the inner edge outside the unit circle; enlarges the three radar charts and tightens the gap above panel i",
